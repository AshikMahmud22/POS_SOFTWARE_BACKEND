...
exports.deleteProfitEntry = exports.updateProfitEntry = exports.getProfitEntries = exports.addProfitEntry = void 0;
const mongodb_1 = require("mongodb");
const profit_1 = require("../types/profit");
const addProfitEntry = async (req, res) => {
    try {
        const db = req.app.locals.db;
        if (!db)
            throw new Error("Database connection not established");
        const collection = (0, profit_1.getProfitCollection)(db);
        const { date } = req.body;
...
exports.addProfitEntry = addProfitEntry;
const getProfitEntries = async (req, res) => {
    try {
        ...
        const availableYears = (Array.isArray(distinctYears) ? distinctYears : []).sort((a, b) => Number(b) - Number(a));
        let availableMonths = [];
        if (year) {
            const monthOrder = [
                "January",
            ...
            availableMonths = (Array.isArray(distinctMonths) ? distinctMonths : []).sort((a, b) => monthOrder.indexOf(a) - monthOrder.indexOf(b));
        }
        res.status(200).json({
            success: true,
            data: entries,
...
exports.getProfitEntries = getProfitEntries;
...
exports.updateProfitEntry = updateProfitEntry;
...
exports.deleteProfitEntry = deleteProfitEntry;
